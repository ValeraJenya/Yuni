...
**Staged allowlist:** `voiceDurationSec` (Int?, длительность голосового в секундах), `messageWeight` (Int, вес сообщения для подсчёта прогресса), `isSystemMessage` (Boolean, флаг системного сообщения), `stage` (Int, текущая стадия conversation), `gamesCompleted` (Int, количество завершённых игр), `postponeCount` (Int, количество отложений игры).
