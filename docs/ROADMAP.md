...
Открытых P0 нет: последний закрыт в Task 063. Из группы P1 по конкурентности
и приватности закрыты 042, 044 и 047; в 046 закрыта первая из четырёх частей.
Следом по приоритету — Task 067 (удаление аккаунта и экспорт данных).
