...
| 080 | Инпут поиска в `/messages` без `id`/`name` | idea | P3 | — | `apps/frontend/app/(app)/messages/page.tsx:315`, консольный issue `A form field element should have an id or name attribute`. Одна строка. Подтверждено дважды независимо: инвентаризацией 2026-08-20 и визуальной проверкой Task 048. |
